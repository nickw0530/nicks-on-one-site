 ...
 * Subscribe form. POSTs to Buttondown's public embed-subscribe
 * endpoint — no API key required.
 * POST https://buttondown.com/api/emails/embed-subscribe/nickw0530
 */
  ...
  async function onSubmit(e: FormEvent<HTMLFormElement>) {
          ...
          try {
            ...
            if (res.ok || res.redirected) {
                    ...
                    // Buttondown may redirect cross-origin; treat as success.
            setDone(true);
                    toast.success("Request sent! Check your inbox to confirm.");
          } finally {
                    setSubmitting(false);
          }
  }
