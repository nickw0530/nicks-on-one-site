...
export default function Subscribe() {
  return (
    ...
    >
      ...
      {/* Integration note (clearly labeled per brief) */}
      <section className="border-b border-ink/15">
        <div className="container py-10">
          <div className="border-l-2 border-[color:var(--noo-accent)] pl-5">
            <p className="kicker-ink mb-1.5">Maintainer note</p>
            <p className="text-ink/70 text-[14.5px] leading-relaxed max-w-2xl">
              The form above captures email locally and shows a confirmation —
              connect it to your provider (Mailchimp, Buttondown, Beehiiv, or
              ConvertKit) by pointing the form's submit handler at your
              provider's API endpoint. No fake backend has been added.
            </p>
          </div>
        </div>
      </section>
